...
<title>Student | Add Experience Details</title>
...
<!--HEADER END--> 
  ...
  <section id="inner-banner">
    ...
    <div class="container">
      ...
      <h1>Student Experience Details</h1>
...
<input type="text" name="employername" placeholder="Name of Company" required="true"  autocomplete="off" value="" class="form-control">
</div>
...
<input type="text" name="ctc" autocomplete="off" placeholder="Enter salary" value="" class="form-control" pattern="[0-9]+">
</div>
