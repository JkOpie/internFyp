...
<input type="email" name="email" id="email" onBlur="userAvailability()"  placeholder="abc@gmail.com" autocomplete="off"  required>
 <span id="user-availability-status1" style="font-size:12px;"></span>
</div>

 <div class="col-md-6 col-sm-6">
 <label>Password</label>
<input type="password" name="empppassword" placeholder="e.g. “Abc123”" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters"  required>
</div>
...
<div class="col-md-6 col-sm-6">
<label>Website</label>
 <input type="url" name="website" placeholder="e.g. http://www.intern.com" autocomplete="off" >
</div>
