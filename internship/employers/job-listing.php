...
<div id="wrapper"> 
  ...
  <section id="inner-banner">
    ...
    <div class="container">
      ...
      <h1>Employer || Internship listing</h1>
...
// Fetching jobs
$sql = "SELECT tbljobs.*,tblemployers.CompnayLogo from tbljobs join tblemployers on tblemployers.id=tbljobs.employerId  where employerId=:eid order by tbljobs.salaryPackage desc LIMIT $offset, $no_of_records_per_page";
...
<div class="hold" style="width:100%">
 ...
 <!-- Job Title -->  
<h4><a href="job-details.php?jobid=<?php echo htmlentities($result->jobId);?>" title='View Details'><?php echo htmlentities($result->jobTitle);?></a> --------- <em><a href="edit-job.php?jobid=<?php echo htmlentities($result->jobId);?>" title='Edit Job Details'>(Edit)</a></em></h4>
...
<!-- Job Package --> 
<?php 
  if($result->salaryPackage != ''){
    echo '
    <strong class="price"><i class="fa fa-money"></i>
    RM '.$result->salaryPackage.'</strong> <br />';
  }
?>
