      ...
      <div class="navigation-col">
        ...
        <nav class="navbar navbar-inverse">
          ...
          <div class="navbar-header">
            ...
            <h2><strong class="logo" style="color:red;padding-top:8%">Internship Portal</strong></h2> </div>
            ...
            <ul class="nav navbar-nav" id="nav">
              <li><a href="#">Internship</a>
                <ul>
                  <li><a href="post-job.php">Post an Internship</a></li>
                  <li><a href="job-listing.php">Manage Internship</a></li>
                </ul>
              </li>
             
 <li><a href="candidates-listings.php">Student List</a></li>
