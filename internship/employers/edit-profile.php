...
<label>Industry</label>
 <input type="text" name="industry" placeholder="e.g. Networking, Information Technology, Programming" autocomplete="off" value="<?php echo htmlentities($result->industry)?>">
</div>

          
<div class="col-md-6 col-sm-6">
<label>Type of Business Entity</label>
 <input type="text" name="typebusinessentity" placeholder="e.g. Sole Proprietorship, Partnership, Foreign" autocomplete="off" value="<?php echo htmlentities($result->typeBusinessEntity)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Location</label>
 <input type="text" name="location" placeholder="e.g. Perliss" autocomplete="off" value="<?php echo htmlentities($result->lcation)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Established In</label>
 <input type="text" name="estin" placeholder="e.g. Sept , 2018" autocomplete="off" value="<?php echo htmlentities($result->establishedIn)?>">
</div>
