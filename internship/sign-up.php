...
<input type="email" name="emailid" id="emailid" onBlur="useremailAvailability()"  placeholder="abc@gmail.com" autocomplete="off"  required>
...
<input type="text" name="contactnumber" id="contactnumber" onBlur="usercontactnoAvailability()"  placeholder="contact number" autocomplete="off" pattern="[0-9]+" title="only numeric digit allowed" maxlength="10" required>
...
<input type="password" name="jspassword" placeholder="e.g. “Abc123”" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="at least one number and one uppercase and lowercase letter, and at least 6 or more characters"  required>
</div>
