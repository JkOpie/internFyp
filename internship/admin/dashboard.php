...
<!doctype html>
 ...
 <head>
 <title>Internship Portal - Admin Dashboard</title>
...
$totcat=$query1->rowCount();?>
                            <a class="block text-center" href="manage-category.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    ...
                                    <p class="font-w600 text-white">Total Internship Category</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?>
                            <a class="block text-center" href="reg-jobseekers.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                    ...
                                    <p class="font-w600 text-white">Total Student</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?> 
                            <a class="block text-center" href="listed-jobs.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                    ...
                                    <p class="font-w600 text-white">Total Internship</p>
                                </div>
                            </a>
                        </div>
