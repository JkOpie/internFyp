...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Internship Portal - Update Contact Us</title>
...
{               ?>        
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" name="mobnum" id="mobnum" required="true" value="<?php  echo $row->MobileNumber;?>" class="form-control" maxlength="15" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
