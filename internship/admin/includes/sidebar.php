                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-l text-dual-primary-dark">INTERNSHIP</span><span class="font-size-l text-primary">PORTAL</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-puzzle"></i><span class="sidebar-mini-hide"></span>Internship Category</a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="reg-jobseekers.php"><i class="si si-users"></i><span class="sidebar-mini-hide">Registered Student</span></a>
                                ...
                                <li>
                                    <a  class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-vector"></i><span class="sidebar-mini-hide">Dates Report</span></a>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="candidates-report.php">Student Report</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="candidates-search.php">Student Search</a>
                                        </li>
