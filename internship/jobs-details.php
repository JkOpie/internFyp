...
<title>Internship Portal || Internship Details</title>
...
{               ?>
                ...
                <div class="text-col">
                  ...
                  <div class="clearfix"> <a href="#" class="btn-freelance"><?php  echo htmlentities($row->jobType);?></a> 
                    ...
                    <a href="sign-up.php" class="btn-style-1">Apply for Internship</a>
 <?php } else { ?>
     <a href="jobs-details.php?ajid=<?php echo ($row->jobId);?>" class="btn-style-1">Apply for Internship</a>
